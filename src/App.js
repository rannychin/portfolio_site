  ...
  return (
    <div className="App">
      ...
      <div className="content">
        <div className="sticky">
          <div className="header" ref={headerRef}>
            ...
            <button
              type="button"
              className={`header_link ${
                visibleSection === "Providers" ? "selected" : ""
              }`}
              onClick={() => {
            ...
            <button
              type="button"
              className={`header_link ${
                visibleSection === "Operations" ? "selected" : ""
              }`}
              onClick={() => {
        ...
        <div className="section" id="Derp" ref={derpRef} />
      </div>
